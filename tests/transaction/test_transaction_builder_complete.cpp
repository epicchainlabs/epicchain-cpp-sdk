...
TEST_CASE("TransactionBuilder Complete Tests", "[transaction]") {
    ...
    Hash160 epicchainTokenHash("0xef4073a0f2b305a38ec4050e4d3d28bc40ea63f5");
    Hash160 epicpulseTokenHash("0xd2a4cff31913016155e38e474a2c06d08be276cf");
    ...
    SECTION("Transfer EpicChain from normal account") {
        TransactionBuilder builder(mockClient);
        
        ScriptBuilder scriptBuilder;
        scriptBuilder.contractCall(epicchainTokenHash, "transfer", {
