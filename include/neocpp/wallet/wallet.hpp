...
public:
    ...
    explicit Wallet(const std::string& name = "EpicChainCpp Wallet", const std::string& version = "1.0");
    ...
    /// Import an account from XEP-2
    /// @param xep2 The XEP-2 encrypted private key
    /// @param password The password to decrypt
    /// @param label Optional label for the account
    /// @return The imported account
    SharedPtr<Account> importFromXEP2(const std::string& xep2, const std::string& password, const std::string& label = "");
    ...
    bool isEmpty() const { return accounts_.empty(); }
