...
public:
    /// Constructor
    InvocationResult() : epicpulseConsumed_(0) {}
    ...
    /// Get epicpulse consumed
    int64_t getepicpulseConsumed() const { return epicpulseConsumed_; }
    void setepicpulseConsumed(int64_t gas) { epicpulseConsumed_ = gas; }
