...
#define LOG_TRACE(msg) epicchaincpp::Logger::trace(msg, __FILE__, __LINE__)
#define LOG_DEBUG(msg) epicchaincpp::Logger::debug(msg, __FILE__, __LINE__)
#define LOG_INFO(msg) epicchaincpp::Logger::info(msg, __FILE__, __LINE__)
#define LOG_WARN(msg) epicchaincpp::Logger::warn(msg, __FILE__, __LINE__)
#define LOG_ERROR(msg) epicchaincpp::Logger::error(msg, __FILE__, __LINE__)
#define LOG_FATAL(msg) epicchaincpp::Logger::fatal(msg, __FILE__, __LINE__)
