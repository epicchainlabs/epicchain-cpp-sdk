...
#include "epicchaincpp/contract/contract.hpp"
...
private:
    ...
    bool isDefault_;
    bool isLocked_;
    std::string encryptedPrivateKey_;  // XEP-2 encrypted
...
public:
    ...
    /// Create account from XEP-2 encrypted key
    /// @param xep2 The XEP-2 encrypted private key
    /// @param password The password to decrypt
    /// @param label Optional label for the account
    Account(const std::string& xep2, const std::string& password, const std::string& label = "");
    ...
    Bytes getVerificationScript() const;
    ...
    /// Export as XEP-2 encrypted key
    /// @param password The password for encryption
    /// @return The XEP-2 encrypted private key
    std::string exportXEP2(const std::string& password) const;
    ...
    /// Import account from XEP-2
    /// @param xep2 The XEP-2 encrypted private key
    /// @param password The password to decrypt
    /// @param label Optional label for the account
    /// @return The imported account
    static SharedPtr<Account> fromXEP2(const std::string& xep2, const std::string& password, const std::string& label = "");
};
