...
public:
    ...
    /// Magic number for EpicChain MainNet
    static constexpr uint32_t NEO_N3_MAINNET_MAGIC = 0x334F454E; // N3MainNet
    
    /// Magic number for EpicChain TestNet
    ...
    // Address prefixes
    static constexpr uint8_t ADDRESS_VERSION = 0x35; // EpicChain address version (53 in decimal)
