...
def swift_to_cpp_name(swift_path):
    ...
    # Get the directory structure after EpicChainSwift/Sources/EpicChainSwift or EpicChainSwift/Tests
    if '/Sources/EpicChainSwift/' in swift_path:
        subpath = swift_path.split('/Sources/EpicChainSwift/')[1]
