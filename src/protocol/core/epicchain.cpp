#include "epicchaincpp/protocol/core/neo.hpp"
...
#include "epicchaincpp/protocol/core/polling/block_polling.hpp"
...
uint32_t Neo::getNetworkMagic() const {
    ...
    if (version) {
        ...
        // The nonce field contains the network magic value in EpicChain
